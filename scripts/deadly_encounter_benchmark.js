    ...
    static _activeDEBM() {
        ...
        if(CR > DEBM + friendlyCR){
            if (game.settings.get("deadly-encounter-benchmark", "tooltip-option")) {isDeadly = 
                ...
                <span class="tooltiptext">${textDEBM} is less than ${newCR}</span>
                </div>
                `
            }
            else {isDeadly = 
        ...
        if(CR == DEBM + friendlyCR){
            if (game.settings.get("deadly-encounter-benchmark", "tooltip-option")) {isDeadly = 
                ...
                <span class="tooltiptext">${textDEBM} is equal to ${newCR}</span>
                </div>
                `
            }
            else {isDeadly = 
        ...
        if(CR < DEBM + friendlyCR){
            if (game.settings.get("deadly-encounter-benchmark", "tooltip-option")) {isDeadly = 
                ...
                <span class="tooltiptext">${textDEBM} is greater than ${newCR}</span>
                </div>
                `
            }
            else {isDeadly = 
