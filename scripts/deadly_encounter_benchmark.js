class DeadlyEncounterBenchmark {  
    ...
    static _activeDEBM() {
        ...
        for(let token of selectedHostile){
            ...
            let cr = token.actor.system.details.cr;
                ...
                if (game.settings.get("deadly-encounter-benchmark", "fraction-option")) {
                    let fcr = cr
                    if (cr < 0 || cr == 0.125){cr = "1⁄8"}
                    if (cr < 0 || cr == 0.25){cr = "1⁄4"}
                    if (cr < 0 || cr == 0.375){cr = "3⁄8"}
                    if (cr < 0 || cr == 0.5){cr = "1⁄2"}
                    if (cr < 0 || cr == 0.625){cr = "5⁄8"}
                    if (cr < 0 || cr == 0.75){cr = "3⁄4"}
                    if (cr < 0 || cr == 0.875){cr = "7⁄8"}
                }
        ...
        if (DEBM > 0 || friendlyCR != 0){
                newDEBM = "<font color='#b94a48'>" + (DEBM + friendlyCR) + "</font> <span title='Deadly Encounter Benchmark'><i class='fa-solid fa-shield-check'></i></span>";
                zeroDEBM = "<font color='#b94a48'>" + (DEBM + friendlyCR) + "</font> <span title='Deadly Encounter Benchmark'><i class='fa-solid fa-shield-check'></i></span>"
            }
        
        //Fractions
        if (game.settings.get("deadly-encounter-benchmark", "fraction-option")) {
            if(DEBM < 0 || DEBM == 0.125){newDEBM = "<font color='#b94a48'>" + "1⁄8" + "</font> <span title='Deadly Encounter Benchmark'><i class='fa-solid fa-shield-check'></i></span>";
                                          zeroDEBM = "<font color='#b94a48'>" + "1⁄8" + "</font> <span title='Deadly Encounter Benchmark'><i class='fa-solid fa-shield-check'></i></span>"}
            if(DEBM < 0 || DEBM == 0.25){newDEBM = "<font color='#b94a48'>" + "1⁄4" + "</font> <span title='Deadly Encounter Benchmark'><i class='fa-solid fa-shield-check'></i></span>";
                                         zeroDEBM = "<font color='#b94a48'>" + "1⁄4" + "</font> <span title='Deadly Encounter Benchmark'><i class='fa-solid fa-shield-check'></i></span>"}
            if(DEBM < 0 || DEBM == 0.375){newDEBM = "<font color='#b94a48'>" + "3⁄8" + "</font> <span title='Deadly Encounter Benchmark'><i class='fa-solid fa-shield-check'></i></span>";
                                          zeroDEBM = "<font color='#b94a48'>" + "3⁄8" + "</font> <span title='Deadly Encounter Benchmark'><i class='fa-solid fa-shield-check'></i></span>"}
            if(DEBM < 0 || DEBM == 0.5){newDEBM = "<font color='#b94a48'>" + "1⁄2" + "</font> <span title='Deadly Encounter Benchmark'><i class='fa-solid fa-shield-check'></i></span>";
                                        zeroDEBM = "<font color='#b94a48'>" + "1⁄2" + "</font> <span title='Deadly Encounter Benchmark'><i class='fa-solid fa-shield-check'></i></span>"}
            if(DEBM < 0 || DEBM == 0.625){newDEBM = "<font color='#b94a48'>" + "5⁄8" + "</font> <span title='Deadly Encounter Benchmark'><i class='fa-solid fa-shield-check'></i></span>";
                                          zeroDEBM = "<font color='#b94a48'>" + "5⁄8" + "</font> <span title='Deadly Encounter Benchmark'><i class='fa-solid fa-shield-check'></i></span>"}
            if(DEBM < 0 || DEBM == 0.75){newDEBM = "<font color='#b94a48'>" + "3⁄4" + "</font> <span title='Deadly Encounter Benchmark'><i class='fa-solid fa-shield-check'></i></span>";
                                         zeroDEBM = "<font color='#b94a48'>" + "3⁄4" + "</font> <span title='Deadly Encounter Benchmark'><i class='fa-solid fa-shield-check'></i></span>"}
            if(DEBM < 0 || DEBM == 0.875){newDEBM = "<font color='#b94a48'>" + "7⁄8" + "</font> <span title='Deadly Encounter Benchmark'><i class='fa-solid fa-shield-check'></i></span>";
                                          zeroDEBM = "<font color='#b94a48'>" + "7⁄8" + "</font> <span title='Deadly Encounter Benchmark'><i class='fa-solid fa-shield-check'></i></span>"}

            if(CR < 0 || CR == 0.125){newCR = "<font color='#b94a48'>" + "1⁄8" + "</font> <span title='Monster CR'><i class='fa-solid fa-swords'></i></span>";
                                      zeroCR = "<font color='#b94a48'>" + "1⁄8" + "</font> <span title='Monster CR'><i class='fa-solid fa-swords'></i></span>"}
            if(CR < 0 || CR == 0.25){newCR = "<font color='#b94a48'>" + "1⁄4" + "</font> <span title='Monster Token CR'><i class='fa-solid fa-swords'></i></span>";
                                     zeroCR = "<font color='#b94a48'>" + "1⁄4" + "</font> <span title='Monster CR'><i class='fa-solid fa-swords'></i></span>"}
            if(CR < 0 || CR == 0.375){newCR = "<font color='#b94a48'>" + "3⁄8" + "</font> <span title='Monster Token CR'><i class='fa-solid fa-swords'></i></span>";
                                      zeroCR = "<font color='#b94a48'>" + "3⁄8" + "</font> <span title='Monster CR'><i class='fa-solid fa-swords'></i></span>"}
            if(CR < 0 || CR == 0.5){newCR = "<font color='#b94a48'>" + "1⁄2" + "</font> <span title='Monster Token CR'><i class='fa-solid fa-swords'></i></span>";
                                    zeroCR = "<font color='#b94a48'>" + "1⁄2" + "</font> <span title='Monster CR'><i class='fa-solid fa-swords'></i></span>"}
            if(CR < 0 || CR == 0.625){newCR = "<font color='#b94a48'>" + "5⁄8" + "</font> <span title='Monster Token CR'><i class='fa-solid fa-swords'></i></span>";
                                      zeroCR = "<font color='#b94a48'>" + "5⁄8" + "</font> <span title='Monster CR'><i class='fa-solid fa-swords'></i></span>"}
            if(CR < 0 || CR == 0.75){newCR = "<font color='#b94a48'>" + "3⁄4" + "</font> <span title='Monster Token CR'><i class='fa-solid fa-swords'></i></span>";
                                     zeroCR = "<font color='#b94a48'>" + "3⁄4" + "</font> <span title='Monster CR'><i class='fa-solid fa-swords'></i></span>"}
            if(CR < 0 || CR == 0.875){newCR = "<font color='#b94a48'>" + "7⁄8" + "</font> <span title='Monster Token CR'><i class='fa-solid fa-swords'></i></span>";
        ...
        if(CR > DEBM + friendlyCR){
            if (game.settings.get("deadly-encounter-benchmark", "tooltip-option")) {isDeadly = 
                `
                <div class="tooltip"><center><span class="isdeadly-backgroundClear">This encounter may be</span><span class="isdeadly-backgroundRed">Deadly</span></center>
                <span class="tooltiptext">${newDEBM} is less than ${newCR}</span>
                </div>
                `
            }
            else {isDeadly = 
        ...
        if(CR == DEBM + friendlyCR){
            if (game.settings.get("deadly-encounter-benchmark", "tooltip-option")) {isDeadly = 
                `
                <div class="tooltip"><center><span class="isdeadly-backgroundClear">This encounter may be</span><span class="isdeadly-backgroundOrange">Challenging</span></center>
                <span class="tooltiptext">${newDEBM} is equal to ${newCR}</span>
                </div>
                `
            }
            else {isDeadly = 
        ...
        if(CR < DEBM + friendlyCR){
            if (game.settings.get("deadly-encounter-benchmark", "tooltip-option")) {isDeadly = 
                `
                <div class="tooltip"><center><span class="isdeadly-backgroundClear">This encounter is</span><span class="isdeadly-backgroundGreen">Not Deadly</span></center>
                <span class="tooltiptext">${newDEBM} is greater than ${newCR}</span>
                </div>
                `
            }
            else {isDeadly = 
        ...
        if (game.settings.get("deadly-encounter-benchmark", "token-outline")) {
            if (game.modules.get("tokenmagic")?.active === true) {
                let params =
                [{
                    filterType: "glow",
            ...
            else if (game.modules.get("tokenmagic")?.active === false) {ui.notifications.warn("Deadly Encounter Benchmark  |  Display Token Outline option selected. Please enable Token Magic FX!")}
            else if (!game.modules.get("tokenmagic")) {ui.notifications.warn("Deadly Encounter Benchmark  |  Display Token Outline option selected. Please enable Token Magic FX!")}
        }
        ...
        let chatContent = ""
            if(CR > DEBM + friendlyCR){chatContent = 
                ...
                <div class="chat">${zeroDEBM} | ${zeroCR}</div>
...
Hooks.on("init", () => {
    ...
    game.settings.register(
        ...
        "tooltip-option",
        {
            name: "deadly-encounter-benchmark.settings.tooltip-option",
            hint: "deadly-encounter-benchmark.settings.tooltip-option-hint",
            scope: "client",
            config: true,
            default: true,
            type: Boolean,
